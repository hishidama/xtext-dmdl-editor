 ...
 *   <li>{@link jp.hishidama.xtext.dmdl_editor.dmdl.ModelDefinition#getType <em>Type</em>}</li>
...
public interface ModelDefinition extends EObject
{
   ...
   * @see #setType(String)
   * @see jp.hishidama.xtext.dmdl_editor.dmdl.DmdlPackage#getModelDefinition_Type()
   * @model
   * @generated
   */
  String getType();
  ...
  /**
   * Sets the value of the '{@link jp.hishidama.xtext.dmdl_editor.dmdl.ModelDefinition#getType <em>Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
