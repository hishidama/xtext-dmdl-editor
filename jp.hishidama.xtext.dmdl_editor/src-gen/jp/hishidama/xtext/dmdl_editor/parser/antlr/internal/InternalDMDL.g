...
entryRulePropertyExpressionList returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getPropertyExpressionListRule()); }
	 iv_rulePropertyExpressionList=rulePropertyExpressionList 
	 { $current=$iv_rulePropertyExpressionList.current; } 
	 EOF 
;

// Rule PropertyExpressionList
rulePropertyExpressionList returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(((
...
entryRulePropertyExpressionMap returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getPropertyExpressionMapRule()); }
	 iv_rulePropertyExpressionMap=rulePropertyExpressionMap 
	 { $current=$iv_rulePropertyExpressionMap.current; } 
	 EOF 
;

// Rule PropertyExpressionMap
rulePropertyExpressionMap returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(((
...
entryRulePropertyExpressionMapEntry returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getPropertyExpressionMapEntryRule()); }
	 ...
	 { $current=$iv_rulePropertyExpressionMapEntry.current; } 
	 EOF 
;

// Rule PropertyExpressionMapEntry
rulePropertyExpressionMapEntry returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleAttributeElementBlock returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getAttributeElementBlockRule()); }
	 iv_ruleAttributeElementBlock=ruleAttributeElementBlock 
	 { $current=$iv_ruleAttributeElementBlock.current; } 
	 EOF 
;

// Rule AttributeElementBlock
ruleAttributeElementBlock returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleAttributeValueMap returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getAttributeValueMapRule()); }
	 iv_ruleAttributeValueMap=ruleAttributeValueMap 
	 { $current=$iv_ruleAttributeValueMap.current; } 
	 EOF 
;

// Rule AttributeValueMap
ruleAttributeValueMap returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(((
...
entryRuleAttributePair returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getAttributePairRule()); }
	 iv_ruleAttributePair=ruleAttributePair 
	 { $current=$iv_ruleAttributePair.current; } 
	 EOF 
;

// Rule AttributePair
ruleAttributePair returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
