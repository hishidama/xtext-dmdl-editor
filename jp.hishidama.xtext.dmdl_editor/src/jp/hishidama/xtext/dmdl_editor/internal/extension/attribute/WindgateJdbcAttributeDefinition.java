...
public class WindgateJdbcAttributeDefinition extends DMDLAttributeWizardDefinition implements DMDLAttributeCompletion {
	...
	public List<String> getCompletionPropertyAttributeElementValueList(String attributeName, AttributeElement element,
		...
		if ("windgate.jdbc.column".equals(attributeName) && "name".equals(elementName)) {
